...
export class DiveplaneClient extends DiveplaneBaseClient {
            ...
            yield batcher(function (size) {
                ...
                return __asyncGenerator(this, arguments, function* () {
                    ...
                    while (offset < cases.length) {
                        ...
                        if (((_a = response.content) === null || _a === void 0 ? void 0 : _a.status) === "optimize") {
                            autoOptimize = true;
                        }
                        offset += size;
     ...
     * @param traineeId The trainee identifier.
     */
    autoOptimize(traineeId) {
        return __awaiter(this, void 0, void 0, function* () {
            const trainee = yield this.autoResolveTrainee(traineeId);
            yield this.execute("auto_optimize", { trainee: trainee.id });
            yield this.autoPersistTrainee(trainee.id);
        });
    }
    /**
     ...
     */
    setAutoOptimize(traineeId, request = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const { experimental_options } = request, rest = __rest(request, ["experimental_options"]);
            const trainee = yield this.autoResolveTrainee(traineeId);
            yield this.execute("set_auto_optimize", Object.assign(Object.assign({ trainee: trainee.id }, SetAutoOptimizeRequestToJSON(rest)), experimental_options));
     ...
     * @param request The optimize parameters.
     */
    optimize(traineeId, request = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const { experimental_options } = request, rest = __rest(request, ["experimental_options"]);
            const trainee = yield this.autoResolveTrainee(traineeId);
            yield this.execute("optimize", Object.assign(Object.assign({ trainee: trainee.id }, OptimizeRequestToJSON(rest)), experimental_options));
        });
    }
    /**
