...
export class WasmClient extends BaseClient {
    constructor(worker, options) {
        ...
        this.fs = new FileSystemClient(this.worker, options === null || options === void 0 ? void 0 : options.libPath);
    }
    /**
    ...
    execute(label, data, throwErrors = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = prepareCoreResponse(response);
            if (throwErrors) {
                for (const err of result.errors) {
                    throw new ProblemError((err === null || err === void 0 ? void 0 : err.message) || "An unknown error occurred.", err === null || err === void 0 ? void 0 : err.code);
                }
            }
            return result;
        });
        ...
        return new Promise((resolve, reject) => {
            ...
            channel.port1.onmessage = (ev) => {
                ...
                if ((_a = ev.data) === null || _a === void 0 ? void 0 : _a.success) {
                    ...
                    if (error instanceof Error && ((_b = ev.data.body) === null || _b === void 0 ? void 0 : _b.name)) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!ready) {
                ...
                if (isNode) {
                    ...
                    yield this.fs.createLazyFile(this.fs.libDir, "howso.caml", String(this.options.coreEntityUri), true, false);
                    yield this.fs.createLazyFile(this.fs.libDir, "trainee_template.caml", String(this.options.traineeEntityUri), true, false);
                }
    ...
    getTraineeSessions(traineeId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { content } = yield this.execute("get_sessions", {
                trainee: trainee.id,
                attributes: ["id", "name"],
            });
     ...
     */
    acquireTraineeResources(traineeId, uri) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.traineeCache.has(traineeId)) {
                // Already acquired
                return;
            ...
            if (uri) {
                ...
                yield this.fs.createLazyFile(this.fs.traineeDir, `${this.fs.sanitizeFilename(traineeId)}.caml`, uri, true, false);
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((cached === null || cached === void 0 ? void 0 : cached.entityId) == this.handle) {
                if (["allow", "always"].indexOf(String(cached.trainee.persistence)) != -1) {
                    ...
                    throw new ProblemError("Trainees set to never persist may not have their resources released. Delete the trainee instead.");
                }
            }
    ...
    createTrainee(trainee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!created) {
                throw new ProblemError(`Could not create a trainee with id '${traineeId}'. Either the trainee template file was not found or the trainee already exists.`);
            }
     ...
     */
    getMarginalStats(traineeId, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const trainee = yield this.autoResolveTrainee(traineeId);
            const { content, warnings = [] } = yield this.execute("get_marginal_stats", Object.assign({ trainee: trainee.id }, FeatureMarginalStatsRequestToJSON(request)));
