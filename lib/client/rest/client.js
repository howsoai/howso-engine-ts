    ...
    waitForAction(action, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield fetchEventSource(`${basePath}/operations/actions/${action.action_id}/subscribe/`, {
            ...
            switch (state.status) {
                ...
                case "failed": {
                    throw DiveplaneApiError.fromJson(state.output);
                }
                default:
...
function isAsyncAcceptedResponse(obj) {
    if (typeof (obj === null || obj === void 0 ? void 0 : obj.action_id) === "string" && typeof (obj === null || obj === void 0 ? void 0 : obj.operation_type) === "string") {
        return true;
    }
    return false;
}
