...
export class TraineeManagementApi extends runtime.BaseAPI {
   ...
   */
  async acquireTraineeResourcesRaw(
    requestParameters: AcquireTraineeResourcesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AsyncActionAccepted>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling acquireTraineeResources.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/resources/acquire`.replace(
          `{${"trainee_id"}}`,
   ...
   * Acquire Trainee resources
   */
  async acquireTraineeResources(
    trainee_id: string,
    TraineeAcquireResourcesRequest?: TraineeAcquireResourcesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AsyncActionAccepted> {
    const response = await this.acquireTraineeResourcesRaw(
      { trainee_id: trainee_id, TraineeAcquireResourcesRequest: TraineeAcquireResourcesRequest },
      initOverrides,
    );
   ...
   * Copy Trainee
   */
  async copyTraineeRaw(
    requestParameters: CopyTraineeOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Trainee>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling copyTrainee.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/copy`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
  ...
  async copyTrainee(
    ...
    const response = await this.copyTraineeRaw(
      { trainee_id: trainee_id, CopyTraineeRequest: CopyTraineeRequest },
      initOverrides,
    );
    return await response.value();
  }
   ...
   * Create Trainee
   */
  async createTraineeRaw(
    requestParameters: CreateTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CreateTraineeActionAccepted>> {
    if (requestParameters.TraineeCreateRequest === null || requestParameters.TraineeCreateRequest === undefined) {
      throw new runtime.RequiredError(
        "TraineeCreateRequest",
        "Required parameter requestParameters.TraineeCreateRequest was null or undefined when calling createTrainee.",
      );
    }
  ...
  async createTrainee(
    TraineeCreateRequest: TraineeCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<CreateTraineeActionAccepted> {
   ...
   * Delete Trainee
   */
  async deleteTraineeRaw(
    requestParameters: DeleteTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling deleteTrainee.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "DELETE",
   ...
   */
  async destructTraineeRaw(
    requestParameters: DestructTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DestructTraineeResponse>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling destructTrainee.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/internal/trainee/{trainee_id}/destruct`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   * Teardown a trainee instance
   */
  async destructTrainee(
    trainee_id: string,
    force?: boolean,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<DestructTraineeResponse> {
   ...
   */
  async getTraineeRaw(
    requestParameters: GetTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Trainee>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling getTrainee.",
      );
    }
   ...
   * List your trainees.
   */
  async listTraineesRaw(
    requestParameters: ListTraineesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<TraineeIdentity>>> {
    const queryParameters: any = {};
   ...
   */
  async persistTraceRaw(
    requestParameters: PersistTraceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TraceResponse>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling persistTrace.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/persist-trace`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   * Persist trainee
   */
  async persistTraineeRaw(
    requestParameters: PersistTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling persistTrainee.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/persist`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   */
  async releaseTraineeResourcesRaw(
    requestParameters: ReleaseTraineeResourcesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling releaseTraineeResources.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/resources/release`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   */
  async resolveTraineeRaw(
    requestParameters: ResolveTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TraineeIdentity>> {
    if (requestParameters.name === null || requestParameters.name === undefined) {
      throw new runtime.RequiredError(
        "name",
        "Required parameter requestParameters.name was null or undefined when calling resolveTrainee.",
      );
    }
   ...
   */
  async selfDestructTraineeRaw(
    requestParameters: SelfDestructTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling selfDestructTrainee.",
      );
    }
   ...
   */
  async setRandomSeedRaw(
    requestParameters: SetRandomSeedRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling setRandomSeed.",
      );
    }
    ...
    if (requestParameters.RandomSeedRequest === null || requestParameters.RandomSeedRequest === undefined) {
      throw new runtime.RequiredError(
        "RandomSeedRequest",
        "Required parameter requestParameters.RandomSeedRequest was null or undefined when calling setRandomSeed.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/random-seed`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   */
  async setTraineeRaw(
    requestParameters: SetTraineeRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Trainee>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling setTrainee.",
      );
    }
    ...
    if (requestParameters.TraineeRequest === null || requestParameters.TraineeRequest === undefined) {
      throw new runtime.RequiredError(
        "TraineeRequest",
        "Required parameter requestParameters.TraineeRequest was null or undefined when calling setTrainee.",
      );
    }
  ...
  async setTrainee(
    ...
    const response = await this.setTraineeRaw(
      { trainee_id: trainee_id, TraineeRequest: TraineeRequest },
      initOverrides,
    );
    return await response.value();
  }
