...
import type { Project, ProjectIdentity } from "../models";
import { ProjectFromJSON, ProjectIdentityToJSON } from "../models";
...
export class ProjectManagementApi extends runtime.BaseAPI {
  ...
  async createProjectRaw(
    ...
    if (requestParameters.ProjectIdentity === null || requestParameters.ProjectIdentity === undefined) {
      throw new runtime.RequiredError(
        "ProjectIdentity",
        "Required parameter requestParameters.ProjectIdentity was null or undefined when calling createProject.",
      );
    }
  ...
  async deleteProjectRaw(
    ...
    if (requestParameters.project_id === null || requestParameters.project_id === undefined) {
      throw new runtime.RequiredError(
        "project_id",
        "Required parameter requestParameters.project_id was null or undefined when calling deleteProject.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/manage/projects/{project_id}/`.replace(
          `{${"project_id"}}`,
          encodeURIComponent(String(requestParameters.project_id)),
        ),
        method: "DELETE",
        headers: headerParameters,
        query: queryParameters,
  ...
  async getProjectRaw(
    ...
    if (requestParameters.project_id === null || requestParameters.project_id === undefined) {
      throw new runtime.RequiredError(
        "project_id",
        "Required parameter requestParameters.project_id was null or undefined when calling getProject.",
      );
    }
  ...
  async updateProjectRaw(
    ...
    if (requestParameters.project_id === null || requestParameters.project_id === undefined) {
      throw new runtime.RequiredError(
        "project_id",
        "Required parameter requestParameters.project_id was null or undefined when calling updateProject.",
      );
    }
    ...
    if (requestParameters.ProjectIdentity === null || requestParameters.ProjectIdentity === undefined) {
      throw new runtime.RequiredError(
        "ProjectIdentity",
        "Required parameter requestParameters.ProjectIdentity was null or undefined when calling updateProject.",
      );
    }
  ...
  async updateProject(
    ...
    const response = await this.updateProjectRaw(
      { project_id: project_id, ProjectIdentity: ProjectIdentity },
      initOverrides,
    );
    return await response.value();
  }
