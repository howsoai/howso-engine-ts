...
import type { AsyncAction, AsyncActionCancel, AsyncActionOutput, AsyncActionStatus } from "../models";
import {
  AsyncActionFromJSON,
...
export class TaskOperationsApi extends runtime.BaseAPI {
   ...
   */
  async cancelActionRaw(
    requestParameters: CancelActionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AsyncActionCancel>> {
    if (requestParameters.action_id === null || requestParameters.action_id === undefined) {
      throw new runtime.RequiredError(
        "action_id",
        "Required parameter requestParameters.action_id was null or undefined when calling cancelAction.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/operations/actions/{action_id}/cancel`.replace(
          `{${"action_id"}}`,
          encodeURIComponent(String(requestParameters.action_id)),
        ),
        method: "PUT",
  ...
  async getActionRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AsyncAction>> {
    if (requestParameters.action_id === null || requestParameters.action_id === undefined) {
      throw new runtime.RequiredError(
        "action_id",
        "Required parameter requestParameters.action_id was null or undefined when calling getAction.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/operations/actions/{action_id}`.replace(
          `{${"action_id"}}`,
          encodeURIComponent(String(requestParameters.action_id)),
        ),
        method: "GET",
   ...
   */
  async getActionOutputRaw(
    requestParameters: GetActionOutputRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AsyncActionOutput | AsyncActionStatus>> {
    if (requestParameters.action_id === null || requestParameters.action_id === undefined) {
      throw new runtime.RequiredError(
        "action_id",
        "Required parameter requestParameters.action_id was null or undefined when calling getActionOutput.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/operations/actions/{action_id}/output`.replace(
          `{${"action_id"}}`,
          encodeURIComponent(String(requestParameters.action_id)),
        ),
        method: "GET",
  ...
  async getActionOutput(
    action_id: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AsyncActionOutput | AsyncActionStatus> {
   ...
   */
  async listPendingActionsRaw(
    requestParameters: ListPendingActionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<AsyncAction>>> {
    const queryParameters: any = {};
   ...
   */
  async listPendingTraineeActionsRaw(
    requestParameters: ListPendingTraineeActionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<AsyncAction>>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling listPendingTraineeActions.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/actions`.replace(
          `{${"trainee_id"}}`,
   ...
   * List pending trainee async actions.
   */
  async listPendingTraineeActions(
    trainee_id: string,
    search?: string,
    ordering?: string,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<AsyncAction>> {
    const response = await this.listPendingTraineeActionsRaw(
      { trainee_id: trainee_id, search: search, ordering: ordering },
      initOverrides,
    );
    return await response.value();
  }
