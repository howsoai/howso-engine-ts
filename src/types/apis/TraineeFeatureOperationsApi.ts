...
export class TraineeFeatureOperationsApi extends runtime.BaseAPI {
   ...
   */
  async addFeatureRaw(
    requestParameters: AddFeatureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling addFeature.",
      );
    }
    ...
    if (requestParameters.FeatureAddRequest === null || requestParameters.FeatureAddRequest === undefined) {
      throw new runtime.RequiredError(
        "FeatureAddRequest",
        "Required parameter requestParameters.FeatureAddRequest was null or undefined when calling addFeature.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/feature/add`.replace(
          `{${"trainee_id"}}`,
   ...
   */
  async getExtremeCasesRaw(
    requestParameters: GetExtremeCasesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Cases>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling getExtremeCases.",
      );
    }
    ...
    if (requestParameters.ExtremeCasesRequest === null || requestParameters.ExtremeCasesRequest === undefined) {
      throw new runtime.RequiredError(
        "ExtremeCasesRequest",
        "Required parameter requestParameters.ExtremeCasesRequest was null or undefined when calling getExtremeCases.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/cases/extreme`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   * Get extreme top or bottom cases for specified feature(s) from a trainee
   */
  async getExtremeCases(
    trainee_id: string,
    ExtremeCasesRequest: ExtremeCasesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Cases> {
    const response = await this.getExtremeCasesRaw(
      { trainee_id: trainee_id, ExtremeCasesRequest: ExtremeCasesRequest },
      initOverrides,
    );
   ...
   */
  async getFeatureAttributesRaw(
    requestParameters: GetFeatureAttributesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: FeatureAttributes }>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling getFeatureAttributes.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/feature/attributes`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      runtime.mapValues(jsonValue, FeatureAttributesFromJSON),
    );
  }
   ...
   */
  async getFeatureConvictionRaw(
    requestParameters: GetFeatureConvictionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FeatureConviction | AsyncActionAccepted>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling getFeatureConviction.",
      );
    }

    if (
      requestParameters.FeatureConvictionRequest === null ||
      requestParameters.FeatureConvictionRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "FeatureConvictionRequest",
        "Required parameter requestParameters.FeatureConvictionRequest was null or undefined when calling getFeatureConviction.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/feature/conviction`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   * Retrieve conviction for features in the model.
   */
  async getFeatureConviction(
    trainee_id: string,
    FeatureConvictionRequest: FeatureConvictionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<FeatureConviction | AsyncActionAccepted> {
    const response = await this.getFeatureConvictionRaw(
      { trainee_id: trainee_id, FeatureConvictionRequest: FeatureConvictionRequest },
      initOverrides,
    );
    return await response.value();
  }
   ...
   */
  async getMarginalStatsRaw(
    requestParameters: GetMarginalStatsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<FeatureMarginalStats>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling getMarginalStats.",
      );
    }

    if (
      requestParameters.FeatureMarginalStatsRequest === null ||
      requestParameters.FeatureMarginalStatsRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "FeatureMarginalStatsRequest",
        "Required parameter requestParameters.FeatureMarginalStatsRequest was null or undefined when calling getMarginalStats.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/feature/stats/marginal`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   * Get marginal stats for features
   */
  async getMarginalStats(
    trainee_id: string,
    FeatureMarginalStatsRequest: FeatureMarginalStatsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<FeatureMarginalStats> {
    const response = await this.getMarginalStatsRaw(
      { trainee_id: trainee_id, FeatureMarginalStatsRequest: FeatureMarginalStatsRequest },
      initOverrides,
    );
    return await response.value();
  }
   ...
   */
  async getSubstitutionMapRaw(
    requestParameters: GetSubstitutionMapRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: any }>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling getSubstitutionMap.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/substitution-map`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "GET",
   ...
   * Remove a feature from a trainee.
   */
  async removeFeatureRaw(
    requestParameters: RemoveFeatureRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling removeFeature.",
      );
    }
    ...
    if (requestParameters.FeatureRemoveRequest === null || requestParameters.FeatureRemoveRequest === undefined) {
      throw new runtime.RequiredError(
        "FeatureRemoveRequest",
        "Required parameter requestParameters.FeatureRemoveRequest was null or undefined when calling removeFeature.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/feature/remove`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   */
  async setFeatureAttributesRaw(
    requestParameters: SetFeatureAttributesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<{ [key: string]: FeatureAttributes }>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling setFeatureAttributes.",
      );
    }
    ...
    if (requestParameters.request_body === null || requestParameters.request_body === undefined) {
      throw new runtime.RequiredError(
        "request_body",
        "Required parameter requestParameters.request_body was null or undefined when calling setFeatureAttributes.",
      );
    }
   ...
   * Set all trainee feature attributes
   */
  async setFeatureAttributes(
    trainee_id: string,
    request_body: { [key: string]: FeatureAttributes },
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<{ [key: string]: FeatureAttributes }> {
    const response = await this.setFeatureAttributesRaw(
      { trainee_id: trainee_id, request_body: request_body },
      initOverrides,
    );
    return await response.value();
  }
   ...
   */
  async setSubstitutionMapRaw(
    requestParameters: SetSubstitutionMapRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling setSubstitutionMap.",
      );
    }
    ...
    if (requestParameters.request_body === null || requestParameters.request_body === undefined) {
      throw new runtime.RequiredError(
        "request_body",
        "Required parameter requestParameters.request_body was null or undefined when calling setSubstitutionMap.",
      );
    }
