...
import type { BeginSessionRequest, Session, UpdateSessionRequest } from "../models";
import { BeginSessionRequestToJSON, SessionFromJSON, UpdateSessionRequestToJSON } from "../models";
...
export class SessionManagementApi extends runtime.BaseAPI {
   ...
   * Start a new session.
   */
  async beginSessionRaw(
    requestParameters: BeginSessionOperationRequest,
    ...
    if (requestParameters.BeginSessionRequest === null || requestParameters.BeginSessionRequest === undefined) {
      throw new runtime.RequiredError(
        "BeginSessionRequest",
        "Required parameter requestParameters.BeginSessionRequest was null or undefined when calling beginSession.",
      );
    }
  ...
  async getSessionRaw(
    ...
    if (requestParameters.session_id === null || requestParameters.session_id === undefined) {
      throw new runtime.RequiredError(
        "session_id",
        "Required parameter requestParameters.session_id was null or undefined when calling getSession.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/manage/sessions/{session_id}/`.replace(
          `{${"session_id"}}`,
          encodeURIComponent(String(requestParameters.session_id)),
        ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
  ...
  async listSessionsRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<Session>>> {
    const queryParameters: any = {};
  ...
  async updateSessionRaw(
    requestParameters: UpdateSessionOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Session>> {
    if (requestParameters.session_id === null || requestParameters.session_id === undefined) {
      throw new runtime.RequiredError(
        "session_id",
        "Required parameter requestParameters.session_id was null or undefined when calling updateSession.",
      );
    }
    ...
    if (requestParameters.UpdateSessionRequest === null || requestParameters.UpdateSessionRequest === undefined) {
      throw new runtime.RequiredError(
        ...
        "Required parameter requestParameters.UpdateSessionRequest was null or undefined when calling updateSession.",
      );
    }
  ...
  async updateSession(
    ...
    const response = await this.updateSessionRaw(
      { session_id: session_id, UpdateSessionRequest: UpdateSessionRequest },
      initOverrides,
    );
    return await response.value();
  }
