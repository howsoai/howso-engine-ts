...
import type { AsyncActionAccepted, DistancesRequest, DistancesResponse, PairwiseDistancesRequest } from "../models";
import {
...
export class TraineeMetricsApi extends runtime.BaseAPI {
   ...
   */
  async distancesRaw(
    requestParameters: DistancesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DistancesResponse>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling distances.",
      );
    }
    ...
    if (requestParameters.DistancesRequest === null || requestParameters.DistancesRequest === undefined) {
      throw new runtime.RequiredError(
        "DistancesRequest",
        "Required parameter requestParameters.DistancesRequest was null or undefined when calling distances.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/metrics/distances`.replace(
          `{${"trainee_id"}}`,
  ...
  async distances(
    ...
    DistancesRequest: DistancesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<DistancesResponse> {
    const response = await this.distancesRaw(
      { trainee_id: trainee_id, DistancesRequest: DistancesRequest },
      initOverrides,
    );
   ...
   */
  async pairwiseDistancesRaw(
    requestParameters: PairwiseDistancesOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AsyncActionAccepted>> {
    if (requestParameters.trainee_id === null || requestParameters.trainee_id === undefined) {
      throw new runtime.RequiredError(
        "trainee_id",
        "Required parameter requestParameters.trainee_id was null or undefined when calling pairwiseDistances.",
      );
    }

    if (
      requestParameters.PairwiseDistancesRequest === null ||
      requestParameters.PairwiseDistancesRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "PairwiseDistancesRequest",
        "Required parameter requestParameters.PairwiseDistancesRequest was null or undefined when calling pairwiseDistances.",
      );
    }
    ...
    const response = await this.request(
      {
        path: `/v2/trainee/{trainee_id}/metrics/pairwise-distances`.replace(
          `{${"trainee_id"}}`,
          encodeURIComponent(String(requestParameters.trainee_id)),
        ),
        method: "POST",
   ...
   * Computes pairwise distances for specified from and to cases or values.
   */
  async pairwiseDistances(
    trainee_id: string,
    PairwiseDistancesRequest: PairwiseDistancesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AsyncActionAccepted> {
    const response = await this.pairwiseDistancesRaw(
      { trainee_id: trainee_id, PairwiseDistancesRequest: PairwiseDistancesRequest },
      initOverrides,
    );
    return await response.value();
  }
