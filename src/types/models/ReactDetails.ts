...
export function ReactDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactDetails {
    ...
    return {
        ...
        'influential_cases_familiarity_convictions': !exists(json, 'influential_cases_familiarity_convictions') ? undefined : json['influential_cases_familiarity_convictions'],
        'influential_cases_raw_weights': !exists(json, 'influential_cases_raw_weights') ? undefined : json['influential_cases_raw_weights'],
        ...
        'num_most_similar_case_indices': !exists(json, 'num_most_similar_case_indices') ? undefined : json['num_most_similar_case_indices'],
        'num_robust_influence_samples_per_case': !exists(json, 'num_robust_influence_samples_per_case') ? undefined : json['num_robust_influence_samples_per_case'],
        ...
        'boundary_cases_familiarity_convictions': !exists(json, 'boundary_cases_familiarity_convictions') ? undefined : json['boundary_cases_familiarity_convictions'],
