 ...
 * @export
 */
export type FeatureAutoDeriveOnTrain = { derive_type: 'custom' } & FeatureAutoDeriveOnTrainCustom | { derive_type: 'progress' } & FeatureAutoDeriveOnTrainProgress;
...
export function FeatureAutoDeriveOnTrainFromJSONTyped(json: any, ignoreDiscriminator: boolean): FeatureAutoDeriveOnTrain {
