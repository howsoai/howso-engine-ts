...
import {
    ...
    ReactAggregateResponseToJSON,
} from './ReactAggregateResponse';
...
export function ReactAggregateActionOutputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactAggregateActionOutput {
