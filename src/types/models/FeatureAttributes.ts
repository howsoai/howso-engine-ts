...
import {
    FeatureAutoDeriveOnTrainFromJSON,
    FeatureAutoDeriveOnTrainToJSON,
} from './FeatureAutoDeriveOnTrain';
...
import {
    FeatureOriginalTypeFromJSON,
    FeatureOriginalTypeToJSON,
} from './FeatureOriginalType';
import type { FeatureTimeSeries } from './FeatureTimeSeries';
import {
    FeatureTimeSeriesFromJSON,
    FeatureTimeSeriesToJSON,
} from './FeatureTimeSeries';
...
* @enum {string}
*/
export type FeatureAttributesDataTypeEnum = 'string' | 'number' | 'boolean' | 'formatted_date_time' | 'string_mixable' | 'json' | 'yaml' | 'amalgam';
...
export function FeatureAttributesFromJSONTyped(json: any, ignoreDiscriminator: boolean): FeatureAttributes {
    ...
    return {
        ...
        'type': json['type'],
        'auto_derive_on_train': !exists(json, 'auto_derive_on_train') ? undefined : FeatureAutoDeriveOnTrainFromJSON(json['auto_derive_on_train']),
