...
export function BaseReactRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseReactRequest {
    ...
    return {
        ...
        'exclude_novel_nominals_from_uniqueness_check': !exists(json, 'exclude_novel_nominals_from_uniqueness_check') ? undefined : json['exclude_novel_nominals_from_uniqueness_check'],
        'use_regional_model_residuals': !exists(json, 'use_regional_model_residuals') ? undefined : json['use_regional_model_residuals'],
        'feature_bounds_map': !exists(json, 'feature_bounds_map') ? undefined : (mapValues(json['feature_bounds_map'], FeatureBoundsFromJSON)),
        ...
        'ordered_by_specified_features': !exists(json, 'ordered_by_specified_features') ? undefined : json['ordered_by_specified_features'],
...
export function BaseReactRequestToJSON(value?: BaseReactRequest | null): any {
    ...
    return {
        ...
        'feature_bounds_map': value.feature_bounds_map === undefined ? undefined : (mapValues(value.feature_bounds_map, FeatureBoundsToJSON)),
