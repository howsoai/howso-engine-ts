...
import {
    ReactAggregateDetailsFromJSON,
    ReactAggregateDetailsToJSON,
} from './ReactAggregateDetails';
...
export function ReactAggregateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactAggregateRequest {
    ...
    return {
        ...
        'feature_influences_action_feature': !exists(json, 'feature_influences_action_feature') ? undefined : json['feature_influences_action_feature'],
        'prediction_stats_action_feature': !exists(json, 'prediction_stats_action_feature') ? undefined : json['prediction_stats_action_feature'],
        'context_features': !exists(json, 'context_features') ? undefined : json['context_features'],
        'hyperparameter_param_path': !exists(json, 'hyperparameter_param_path') ? undefined : json['hyperparameter_param_path'],
        'num_robust_influence_samples': !exists(json, 'num_robust_influence_samples') ? undefined : json['num_robust_influence_samples'],
        ...
        'num_robust_residual_samples': !exists(json, 'num_robust_residual_samples') ? undefined : json['num_robust_residual_samples'],
        ...
        'confusion_matrix_min_count': !exists(json, 'confusion_matrix_min_count') ? undefined : json['confusion_matrix_min_count'],
        'residuals_hyperparameter_feature': !exists(json, 'residuals_hyperparameter_feature') ? undefined : json['residuals_hyperparameter_feature'],
