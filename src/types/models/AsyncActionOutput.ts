 ...
 * @export
 */
export type AsyncActionOutput =
  | ({ status: "cancelled" } & AsyncActionCancelledOutput)
  | ({ status: "complete" } & AsyncActionCompleteOutput)
  | ({ status: "failed" } & AsyncActionFailedOutput);
