...
* @enum {string}
*/
export type ReactAggregateDetailsSelectedPredictionStatsEnum = 'all' | 'accuracy' | 'confusion_matrix' | 'mae' | 'precision' | 'r2' | 'recall' | 'rmse' | 'spearman_coeff' | 'mcc' | 'missing_value_accuracy';
...
export function ReactAggregateDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactAggregateDetails {
    ...
    return {
        ...
        'action_condition_precision': !exists(json, 'action_condition_precision') ? undefined : json['action_condition_precision'],
        ...
        'context_condition_precision': !exists(json, 'context_condition_precision') ? undefined : json['context_condition_precision'],
        'context_precision_num_cases': !exists(json, 'context_precision_num_cases') ? undefined : json['context_precision_num_cases'],
        'prediction_stats_features': !exists(json, 'prediction_stats_features') ? undefined : json['prediction_stats_features'],
        'selected_prediction_stats': !exists(json, 'selected_prediction_stats') ? undefined : json['selected_prediction_stats'],
    };
}
