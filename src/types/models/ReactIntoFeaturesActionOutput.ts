...
import {
    ...
    ReactIntoFeaturesResponseToJSON,
} from './ReactIntoFeaturesResponse';
...
export function ReactIntoFeaturesActionOutputFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactIntoFeaturesActionOutput {
