...
export function ReactAggregateResponseContentConfusionMatrixFromJSON(json: any): ReactAggregateResponseContentConfusionMatrix {
    return ReactAggregateResponseContentConfusionMatrixFromJSONTyped(json, false);
}

export function ReactAggregateResponseContentConfusionMatrixFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactAggregateResponseContentConfusionMatrix {
...
export function ReactAggregateResponseContentConfusionMatrixToJSON(value?: ReactAggregateResponseContentConfusionMatrix | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
