...
export function ReactGroupResponseContentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactGroupResponseContent {
    ...
    return {
        ...
        'base_model_average_distance_contribution': !exists(json, 'base_model_average_distance_contribution') ? undefined : json['base_model_average_distance_contribution'],
        'combined_model_average_distance_contribution': !exists(json, 'combined_model_average_distance_contribution') ? undefined : json['combined_model_average_distance_contribution'],
    };
}
