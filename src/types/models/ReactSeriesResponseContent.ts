...
import {
    DerivationParametersFromJSON,
    DerivationParametersToJSON,
} from './DerivationParameters';
...
export function ReactSeriesResponseContentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReactSeriesResponseContent {
    ...
    return {
        ...
        'categorical_action_probabilities': !exists(json, 'categorical_action_probabilities') ? undefined : json['categorical_action_probabilities'],
        'derivation_parameters': !exists(json, 'derivation_parameters') ? undefined : ((json['derivation_parameters'] as Array<any>).map(DerivationParametersFromJSON)),
        ...
        'feature_mda_ex_post_robust': !exists(json, 'feature_mda_ex_post_robust') ? undefined : json['feature_mda_ex_post_robust'],
        'directional_feature_contributions_full': !exists(json, 'directional_feature_contributions_full') ? undefined : json['directional_feature_contributions_full'],
        'directional_feature_contributions_robust': !exists(json, 'directional_feature_contributions_robust') ? undefined : json['directional_feature_contributions_robust'],
        ...
        'case_directional_feature_contributions_full': !exists(json, 'case_directional_feature_contributions_full') ? undefined : json['case_directional_feature_contributions_full'],
        'case_directional_feature_contributions_robust': !exists(json, 'case_directional_feature_contributions_robust') ? undefined : json['case_directional_feature_contributions_robust'],
        'case_feature_contributions_full': !exists(json, 'case_feature_contributions_full') ? undefined : json['case_feature_contributions_full'],
        'case_feature_contributions_robust': !exists(json, 'case_feature_contributions_robust') ? undefined : json['case_feature_contributions_robust'],
        ...
        'case_contributions_robust': !exists(json, 'case_contributions_robust') ? undefined : json['case_contributions_robust'],
        'case_feature_residuals_full': !exists(json, 'case_feature_residuals_full') ? undefined : json['case_feature_residuals_full'],
        'case_feature_residuals_robust': !exists(json, 'case_feature_residuals_robust') ? undefined : json['case_feature_residuals_robust'],
        'local_case_feature_residual_convictions_full': !exists(json, 'local_case_feature_residual_convictions_full') ? undefined : json['local_case_feature_residual_convictions_full'],
        'local_case_feature_residual_convictions_robust': !exists(json, 'local_case_feature_residual_convictions_robust') ? undefined : json['local_case_feature_residual_convictions_robust'],
        'global_case_feature_residual_convictions_full': !exists(json, 'global_case_feature_residual_convictions_full') ? undefined : json['global_case_feature_residual_convictions_full'],
        'global_case_feature_residual_convictions_robust': !exists(json, 'global_case_feature_residual_convictions_robust') ? undefined : json['global_case_feature_residual_convictions_robust'],
        ...
        'distance_ratio_parts': !exists(json, 'distance_ratio_parts') ? undefined : ((json['distance_ratio_parts'] as Array<any>).map(DetailsResponseDistanceRatioPartsInnerFromJSON)),
        ...
        'most_similar_case_indices': !exists(json, 'most_similar_case_indices') ? undefined : json['most_similar_case_indices'],
...
export function ReactSeriesResponseContentToJSON(value?: ReactSeriesResponseContent | null): any {
    ...
    return {
        ...
        'derivation_parameters': value.derivation_parameters === undefined ? undefined : ((value.derivation_parameters as Array<any>).map(DerivationParametersToJSON)),
        ...
        'distance_ratio_parts': value.distance_ratio_parts === undefined ? undefined : ((value.distance_ratio_parts as Array<any>).map(DetailsResponseDistanceRatioPartsInnerToJSON)),
