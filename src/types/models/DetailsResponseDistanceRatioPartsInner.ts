...
export function DetailsResponseDistanceRatioPartsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): DetailsResponseDistanceRatioPartsInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'local_distance_contribution': !exists(json, 'local_distance_contribution') ? undefined : json['local_distance_contribution'],
        'nearest_distance': !exists(json, 'nearest_distance') ? undefined : json['nearest_distance'],
    };
}

export function DetailsResponseDistanceRatioPartsInnerToJSON(value?: DetailsResponseDistanceRatioPartsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
